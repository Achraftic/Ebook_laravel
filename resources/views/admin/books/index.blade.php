        ...
        <div class="mt-2 px-4 py-2 w-full space-y-4 max-w-9xl mx-auto flex flex-wrap justify-between items-center">
            <div class="flex space-x-2 items-center">
                ...
                <a href="{{ route('books.create') }}"
                    class="bg-orange-500 text-white p-2 rounded-md flex items-center  px-3 py-2 "> <svg
            ...
            <form method="get" action="{{route('books.search')}}" class="flex   sm:space-y-0 space-y-2 flex-wrap  items-center h-max space-x-1">
               @csrf
                <input type="text" name="search" class="border border-slate-300 w-full md:w-auto  rounded-md"
        ...
        <div class=" mt-2 px-4 py-8 w-full max-w-9xl mx-auto">
            ...
            <div class="bg-white shadow-xl rounded-sm border border-slate-200 mb-8">
                <header class="px-5 py-4">
                    <h2 class="font-semibold text-slate-800">ALL Books <span class="text-slate-400 font-medium">{{$countbook}}</span>
                    </h2>
                </header>
                            ...
                            <tbody class=" text-sm divide-y divide-slate-200">
                                ...
                                @foreach ($data as $key => $book)
                                    <tr>
                                        ...
                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                            <div class="font-medium text-slate-700"> {{ $book->category->name }} </div>
                                        </td>

                                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                            <div class=" flex items-center ">
                                                <a href="{{route('books.edit',$book->id)}}" class="text-slate-400 hover:text-slate-500 rounded-full">
                                                ...
                                                <a href="{{ route('books.delete', $book->id) }}" id=""
                                                    class="text-rose-500 hover:text-rose-600 rounded-full delete">
