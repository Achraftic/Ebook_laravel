...
@section('content')
    ...
    <section class="">
        <div class="mt-2 px-4 py-2 w-full space-y-4 max-w-9xl mx-auto flex flex-wrap justify-between items-center">
            <h1 class="text-3xl md:text-4xl text-slate-800 font-bold">Edit  Category Book</h1>
        </div>
        <form action="{{route('category.update',$data->id) }} " method="post" enctype="multipart/form-data"
            ...
            <input id="Name" class="form-input sm:w-[80%] w-full focus:ring-orange-600 " value="{{$data->name}}" name="name" type="text" placeholder="Example: fantasy" />
