                   ...
                   <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                       ...
                       <div>
                           ...
                           <div class="flex -mx-3">
                               <div class="w-full px-3 mb-5">
                                   ...
                                   <div class="flex">
                                       ...
                                       <input type="email" name="email" id="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-orange-500" placeholder="johnsmith@example.com">
                           ...
                           <div class="flex items-center  relative  -mx-3">
                               <div class="w-full px-3 mb-0">
                                   ...
                                   <div class="flex">
                                       ...
                                       <input type="password" name="password" id ="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-orange-500" placeholder="************">
                                   </div>
                           ...
                           @endif
                            ...
                            <div class="flex    ">
                                <div class="w-full px-2 my-3 mt-5">
                                 @if (Route::has('password.request'))
                                 <a class="underline text-[13px] text-blue-600 hover:text-blue-900" href="{{ route('password.request') }}">
                           ...
                           <div class="flex mt-3 -mx-3">
                               <div class="w-full px-3 mb-5">
                                   <button class="block w-full max-w-xs mx-auto bg-orange-500 hover:bg-orange-400 focus:bg-orange-700 text-white rounded-lg px-3 py-3 font-semibold">Login</button>
                               </div>
                           </div>
                       </div>
                   </div>
    ...
    <div class="flex-1   w-full  bg-white rounded-lg shadow-xl dark:bg-gray-950/90">
        ...
        <div class="flex items-center justify-center p-6 sm:p-12  ">
          <div class="w-full">
            ...
            <button type="submit" class="block w-full px-4 py-3 mt-7 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-[#FD7014] border border-transparent rounded-lg active:bg-orange-600 hover:bg-orange-600 focus:outline-none focus:shadow-outline-purple">
